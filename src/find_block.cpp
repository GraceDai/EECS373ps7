...
void ImageConverter::imageCb(const sensor_msgs::ImageConstPtr& msg){
	...
	////////////////////////////////////////////////////inserted////////////////////////////
	double i = 0.0029512 * (i_centroid - 320);
	double j = 0.0029512 * (j_centroid - 240);	
	block_pose_.pose.position.x = (0.9787340*i - 0.205133*j + .545); 
	block_pose_.pose.position.y = -1*(0.205133* + 0.9787340*j - .317);
	double theta = .2066;
	////////////////////////////////////////////////////////////////////////////////////////
